...
const allurl = "https://trekkingtech-backend2022.herokuapp.com/api/auth/alldata";
  ...
  await fetch(allurl, {
    ...
    .then(async (res) => {
      ...
      // '<ion-icon name="checkmark-circle-outline"></ion-icon>';
        ...
        window.location.replace("https://trekkingtech-backend2022.herokuapp.com/login.html");
      }
    })
    .catch((err) => {
      console.log(err);
